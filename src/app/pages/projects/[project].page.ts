...
import {AsyncPipe, JsonPipe, NgForOf, NgIf, NgOptimizedImage, TitleCasePipe} from '@angular/common';
...
@Component({
  ...
  standalone: true,
  imports: [NgIf, MarkdownComponent, AsyncPipe, JsonPipe, MainLayoutComponent, ReplacePipe, NgForOf, NgOptimizedImage, TitleCasePipe],
  template: `
    <layout-main>
        ...
        <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
          <div class="relative sm:py-16 lg:py-0">
            ...
            <div aria-hidden="true" class="hidden sm:block lg:absolute lg:inset-y-0 lg:right-0 lg:w-screen">
              <div class="absolute inset-y-0 right-1/2 w-full bg-secondary rounded-r-3xl lg:right-72"></div>
              <svg class="absolute top-8 left-1/2 -ml-3 lg:-right-8 lg:left-auto lg:top-12" width="404" height="392" fill="none" viewBox="0 0 404 392">
                <defs>
                  <pattern id="02f20b47-fd69-4224-a62a-4c9de5c763f7" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
                    <rect x="0" y="0" width="4" height="4" class="fill-accent" fill="currentColor" />
                  </pattern>
                </defs>
...
<!--                <div class="absolute inset-0 bg-gradient-to-t from-primary via-primary opacity-90"></div>-->
                <div class="absolute inset-0 bg-gradient-to-t from-primary to-primary"></div>
                <div class="relative">
                  <div class="flex">
                  ...
                  <div class="flex mt-4 bg-base-300 rounded-2xl p-2">
                    ...
                    <div class="tags w-1/2 flex justify-end">
                      <span [class]="tagColorMap[tag] || 'badge bg-primary-500 border-primary-500'" *ngFor="let tag of item?.tags">
                        {{tag | titlecase}}
                      </span>
                    </div>
                  </div>
