...
<!--    <app-hello></app-hello>-->
    <layout-main>
      ...
      <ng-template let-item="projectItem" #itemTemplate>
        <div class="card hover:bg-secondary cursor-pointer bg-base-100 shadow-xl indicator transition-all ease-in delay-50"
             [routerLink]="item?.title | lowercase | replace"
        >
